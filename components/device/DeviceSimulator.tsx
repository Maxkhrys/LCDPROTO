...
export default function DeviceSimulator() {
  ...
  return (
    <div
      className="sim-ui relative flex min-h-[calc(100dvh-24px)] w-full flex-col items-center gap-3 sm:gap-4"
      data-console-open={controlsOpen ? "true" : "false"}
    >
      <ControlCenter
        open={controlsOpen}
      ...
      <div className="flex min-h-0 w-full flex-1 items-center justify-center">
        <div ref={frameRef} className="device-stage flex aspect-square w-full max-w-full items-center justify-center" style={{ width: `min(100%, ${Math.round(DEFAULT_OUTER * screenScale)}px, max(280px, calc(100dvh - 76px)))` }}>
